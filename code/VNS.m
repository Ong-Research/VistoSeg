...
Img1_smooth = imgaussfilt(Img1,1.5); %smooth image
%he = imadjust(Img1_smooth, [.2 .3 0; .6 .7 1],[]); %default adjust contrast in image
%he = imadjust(Img1_smooth, [0.1 .3 .1; .5 .7 .9],[]);
%he = imadjust(Img1_smooth, [0.1 .3 .1; .85 .75 .9],[]);
he = imadjust(Img1_smooth, [0.2 .3 .1; .85 .75 .9],[]);
imwrite(he, [strcat(fullfile(path1,name1),".he.tif")])
clear Img1_smooth
toc
